...
def force_manual_signing(target, profile_name)
...
if main_target
  force_manual_signing(main_target, 'Growth Labs Connect')
end

widget_target = project.targets.find { |t| t.name == 'GrowthTimerWidgetExtension' }
if widget_target
  force_manual_signing(widget_target, 'Growth Labs Widget Connect')
end
