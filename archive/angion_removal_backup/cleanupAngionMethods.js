...
exports.cleanupAngionMethods = functions.https.onRequest(async (req, res) => {
    try {
        ...
        // Step 1: Remove methods from growth_exercises collection
        console.log('Step 1: Removing methods from growth_exercises collection...');
        const methodsRef = db.collection('growth_exercises');
