...
exports.generateAIResponse = onCall(
  ...
  async (request) => {
    ...
    try {
      ...
      if (!vertexAIProxy) {
        vertexAIProxy = require('./vertexAiProxy/index');
      }
...
exports.collectAPNsDiagnostics = collectAPNsDiagnostics;

// Educational resource image update functions
const educationalResourceFunctions = require('./updateEducationalResourceImages');
exports.updateEducationalResourceImages = educationalResourceFunctions.updateEducationalResourceImages;
exports.updateEducationalResourceImagesCallable = educationalResourceFunctions.updateEducationalResourceImagesCallable;
