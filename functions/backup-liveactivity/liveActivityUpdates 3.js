...
async function sendLiveActivityUpdate(pushToken, activityId, contentState, dismissalDate = null, topicOverride = null, preferredEnvironment = 'auto') {
  ...
  if (contentState.startedAt !== undefined) {
    ...
    console.log('📋 Simplified contentState for iOS:', JSON.stringify(convertedContentState, null, 2));
  ...
  if (contentState.startedAt !== undefined) {
    ...
    console.log('📋 Converted contentState for iOS (legacy):', JSON.stringify(convertedContentState, null, 2));
...
exports.registerLiveActivityPushToken = onCall(
  ...
  async (request) => {
    console.log('📱 registerLiveActivityPushToken called');
    ...
    try {
      ...
      console.log(`✅ Live Activity token registered for activity: ${activityId}`);
...
exports.registerPushToStartToken = onCall(
  ...
  async (request) => {
    console.log('📱 registerPushToStartToken called');
    ...
    try {
      ...
      console.log(`✅ Push-to-start token registered for user: ${request.auth.uid}`);
