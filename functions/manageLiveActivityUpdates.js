...
// Always use production host and key for Live Activities
const APNS_HOST = 'api.push.apple.com'; // Production host only
const TEAM_ID = process.env.APNS_TEAM_ID?.trim() || '62T6J77P6R';
const KEY_ID = process.env.APNS_KEY_ID?.trim() || 'DQ46FN4PQU'; // Production key only
