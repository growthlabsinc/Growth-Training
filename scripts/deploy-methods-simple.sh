...
echo "🚀 Deploying Angion Methods to Firebase..."
echo ""
...
echo "  - Vascion"
echo ""
echo "⚠️  IMPORTANT: This requires manual steps:"
echo ""
echo "1. Open Firebase Console: https://console.firebase.google.com/project/growth-training-app/firestore/data/~2FgrowthMethods"
echo ""
