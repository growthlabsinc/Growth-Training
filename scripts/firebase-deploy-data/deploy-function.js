...
exports.deployAngionMethods = functions.https.onCall(async (data, context) => {
  ...
  "title": "Angion Method 1.0 (Detailed)",
  ...
  "steps": [
    {
      ...
      "warnings": [
        "Avoid parabens and methyl parabens in lubricants"
      ]
    },
    {
      "stepNumber": 2,
      ...
      "warnings": [
        "If you have severe arterial insufficiency/underdevelopment, consult a healthcare provider"
      ]
    },
    {
      "stepNumber": 3,
  ...
  "progressionCriteria": {
    ...
    "consistencyDays": 14,
    "keyIndicators": [
      "Can maintain technique for full 30 minutes",
      "Noticeable improvement in vascular visibility",
      "Better resting fullness",
      "Able to maintain moderate to fast pace"
    ],
    "readinessMarkers": [
      "Superficial dorsal vein becomes visible",
      "Less erection loss during sessions",
  ...
  "steps": [
    {
      ...
      "warnings": [
        "Never exceed 4hg pressure",
        "Ideally stay at or below 3hg"
      ]
    },
    {
      "stepNumber": 2,
    ...
    },
    {
      ...
      "warnings": [
        "Maximum 10 minutes for beginners"
      ]
    },
    {
      "stepNumber": 6,
