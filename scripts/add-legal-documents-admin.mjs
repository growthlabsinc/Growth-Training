...
// Script to add legal documents to Firestore using Firebase Admin SDK
// Usage: 
// 1. Download service account key from Firebase Console
// 2. Run: GOOGLE_APPLICATION_CREDENTIALS="path/to/key.json" node scripts/add-legal-documents-admin.mjs
...
if (!process.env.GOOGLE_APPLICATION_CREDENTIALS) {
  ...
  console.error('\nTo run this script:');
  console.error('1. Go to https://console.firebase.google.com/project/growth-70a85/settings/serviceaccounts/adminsdk');
  console.error('2. Click "Generate new private key" and save the JSON file');
  console.error('3. Run: GOOGLE_APPLICATION_CREDENTIALS="path/to/key.json" node scripts/add-legal-documents-admin.mjs\n');
  process.exit(1);
}
...
async function addLegalDocuments() {
  ...
  console.log('\n✅ Legal documents have been added to Firestore!');
  console.log('\nYou can now test them in the app:');
  console.log('- Go to Settings > Privacy Policy');
  console.log('- Go to Settings > Terms of Use');
  console.log('- Go to Settings > Medical Disclaimer');
