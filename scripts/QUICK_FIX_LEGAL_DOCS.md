...
3. Collection ID: `legalDocuments`
...
4. Add first document:
   ...
   - Fields:
     ...
     - `lastUpdated` (timestamp): Click the clock icon and select current date/time
     - `content` (string): Copy the privacy policy text below

5. Repeat for `terms_of_use` and `disclaimer`
