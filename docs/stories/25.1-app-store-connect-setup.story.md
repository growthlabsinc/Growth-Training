...
```
Production URL: https://us-central1-growth-training-app.cloudfunctions.net/handleAppStoreNotification
Sandbox URL: https://us-central1-growth-training-app.cloudfunctions.net/handleAppStoreNotificationSandbox
Version: Version 2
```
